          ...
          <div className="space-y-6">
            ...
            <div className="px-4 -mt-20 md:-mt-60 relative z-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              {[
                ...
                { title: 'VapesHub Express', items: [{name: 'Same-day Pickup', img: '/images/sameday_delivery_1773423053852.png'}, {name: 'Local Delivery', img: '/images/sameday_delivery_1773423053852.png'}, {name: 'Subscription', img: '/images/subscription_box_1773423072371.png'}, {name: 'Bulk Deals', img: '/images/bulk_deals_1773423095884.png'}] },
              ].map((cat, i) => (
