...
import { fetchProducts, fetchCurrentUser, fetchVendorStats, fetchAdminStats } from './services/api';
              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-5 bg-slate-900/50">
                {aiMessages.map((msg, i) => (
                  <div key={i} className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                    <div className={`max-w-[85%] p-4 rounded-2xl text-xs font-black uppercase tracking-tight shadow-sm leading-relaxed ${
                      msg.role === 'user' 
