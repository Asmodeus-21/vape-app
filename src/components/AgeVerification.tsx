import { AlertCircle, Camera, CheckCircle2, Database, FileText, Shield, Upload, Zap } from 'lucide-react';
                            ...
                            <div className="bg-slate-50 border border-slate-100 rounded-3xl p-8 space-y-4">
                                <div className="flex items-start gap-5">
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <p className="text-xs text-slate-500 font-medium leading-relaxed">Banana Leaf Store operates under strict regulatory frameworks. All clients must be 21+ to initialize hardware nodes or chemical assets.</p>
                                    </div>
                                </div>
                            </div>
                            <button
                    ...
                    {step === 'success' && (
                        ...
                        >
                            ...
                            <div className="space-y-3">
                                ...
                                <p className="text-slate-500 font-medium text-sm">Welcome to the inner circle. Your account is now authorized for the full Banana Leaf Store supply network.</p>
                            </div>
                            <button
                                onClick={onVerified}
