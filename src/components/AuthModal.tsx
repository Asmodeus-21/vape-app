import { Eye, EyeOff, Loader2, Lock, Mail, MapPin, ShoppingBag, User, X, Zap } from 'lucide-react';
...
export default function AuthModal({ onClose, onAuthSuccess }: AuthModalProps) {
    ...
    const handleRegister = async (e: React.FormEvent) => {
        ...
        if (isVendor && !storeName.trim()) {
            setError('Store name is required for franchise onboarding.');
            return;
        }
        setLoading(true);
        try {
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <div className="relative group">
                                                    ...
                                                    <input
                                                        ...
                                                        placeholder="DOWNTOWN FRANCHISE"
                                                        className="w-full pl-12 pr-4 py-4 bg-white border border-slate-100 rounded-2xl focus:outline-none focus:border-brand-primary focus:ring-4 focus:ring-brand-primary/10 transition-all text-sm font-bold placeholder:text-slate-300"
                                                    />
                                                </div>
                                            </div>
                                            <div className="space-y-2">
