import { Beaker, DollarSign, Edit, FileText, Loader2, PackagePlus, Tag, Upload, X } from 'lucide-react';
import React, { useState } from 'react';
import toast from 'react-hot-toast';
import { createVendorProduct, updateVendorProduct } from '../services/api';
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (isEdit) {
                ...
                toast.success('Product successfully added to Banana Leaf Store!');
            }
            onSuccess();
        } catch (err: any) {
